        ...
        <div className="w-full min-h-screen bg-light scroll-smooth">
          ...
          <div className="px-4 space-y-4 flex flex-col lg:flex-row lg:space-y-0 lg:space-x-6 mb-14">
            ...
            <p className="text-4xl font-bold lg:w-3/4">
              ...
              cross-platform mobile application. Our mission is to recast how
              people explore, shop, socialize, and engage online.
            </p>
          </div>

          <div id="features" className="px-32 space-y-4 inline-flex lg:space-y-0">
            <div className="py-10">
              <img src="/virtual_fitting.jpg" className="h-144 rounded-2xl scale-110 hover:scale-105 transition-all duration-200 hover:brightness-50 cursor-pointer" />
            </div>
            <div className="px-20">
              <p className="font-ubuntu text-base font-normal static">• Our Features</p>
              <div className="py-4">
